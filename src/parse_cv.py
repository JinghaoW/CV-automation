...
def extract_skills_with_llm(cv_text: str, client: OpenAI) -> dict:
    ...
    prompt = (
        ...
        "  - name (string)\n"
        "  - skills (list of strings – focus on TECHNICAL and HARD skills such as "
        "programming languages, frameworks, libraries, tools, platforms, databases, "
        "and domain-specific expertise. Omit generic soft skills like 'teamwork' or "
        "'communication'. These will be used as job search keywords.)\n"
